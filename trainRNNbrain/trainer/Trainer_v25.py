...
class Trainer():
    ...
    @staticmethod
    def gini_penalty(x, eps=1e-8, min_range=0.05, tau=0.0):
        """
        ...
        rng = torch.maximum(vmax - vmin, v.new_tensor(min_range))
        v = (v - vmin) / rng
    ...
    def activity_penalty(self, states):
        ...
        return self.gini_penalty(activity) + 0.1 * torch.mean(torch.abs(activity))
