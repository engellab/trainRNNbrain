...
class Trainer():
    ...
    def train_step(self, input, target_output, mask):
        states, predicted_output, hs = self.RNN(input)
        ...
        contribution_penalty = self.lambda_z * (1.0 - entropy / max_entropy)  # bounded [0,1])
        ...
        self.loss_monitor["inactivity"].append(contribution_penalty.detach())
        return loss.item()
