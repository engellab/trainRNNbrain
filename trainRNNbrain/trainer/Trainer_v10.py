...
class Trainer():
    ...
    def E2I_penalty(self, threshold=0.6):
        ...
        penalty = torch.relu(threshold - E2I_ratios)
    ...
    def isolation_penalty(self, percent=0.5, min_threshold=0.01):
        ...
        incoming_penalty = torch.mean((torch.relu(threshold - incoming_weights) / threshold) ** 2)
