...
taskname = 'CDDM'
activation = "relu"
train_config_file = f"train_config_CDDM_{activation};N=50;lmbdr=0.5;lmbdo=0.3;orth_inp_only=True.json"
...
match activation_name:
    case 'relu': activation = lambda x: np.maximum(0, x)
    case 'tanh': activation = lambda x: np.tanh(x)
